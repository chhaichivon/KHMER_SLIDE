...
<head>
  <meta charset="UTF-8">
  <title>Khmer Slide</title>
    <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/resources/login/logo/logo.png" sizes="32x32" />
  ...
  <script src='${pageContext.request.contextPath}/resources/dist/lib/swagger-oauth.js' type='text/javascript'></script>
    ...
    $(function () {
      ...
      function addApiKeyAuthorization(){
        ...
        if(key && key.trim() != "") {
            var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("Authorization", "Basic a3NsOmtzbGFwaQ==", "header");
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo">
    	<img alt="" src="${pageContext.request.contextPath}/resources/login/logo/logo.png" width="300"></a>
    <form id='api_selector'>
     <!--  <div class='input'><input placeholder="http://example.com/api" id="input_baseUrl" name="baseUrl" type="text"/></div>
      <div class='input'><input placeholder="api_key" id="input_apiKey" name="apiKey" type="text"/></div> -->
      <div class='input'><input placeholder="${pageContext.request.contextPath}/api-docs" value="${pageContext.request.contextPath}/api" id="input_baseUrl" name="baseUrl" type="hidden"/></div>
      <div class='input'><input placeholder="api_key" value="Basic a3NsOmtzbGFwaQ==" id="input_apiKey" name="apiKey" type="hidden"/></div>
<!--       
