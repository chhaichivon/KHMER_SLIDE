...
<%@ taglib prefix="sec"
	...
	<sec:authentication property="principal.id" var="adminId"/>
</sec:authorize>
<div ng-controller="sessoinCtrl">
	<div class="search-bar closed">
		<form>
			<div class="input-group input-group-lg">
				<input type="text" placeholder="ស្វែងរក..." class="form-control"><span
	...
	<a href="/index.ks" class="brand pull-left"><img
		src="${pageContext.request.contextPath}/resources/static/img/logo/logo-login.png"
		alt="" width="150" height="20"></a> <a href="javascript:;" role="button"
		class="hamburger-menu pull-left"><span></span></a>
	<form class="search-form pull-left hidden-xs">
		<div class="form-group has-feedback mb-0">
			<input type="text" aria-describedby="inputSearchFor"
				placeholder="ស្វែងរក..." style="width: 200px"
	...
	<ul class="notification-bar list-inline pull-right">
		...
		<li class="dropdown visible-lg visible-md"><a id="dropdownMenu2"
			...
			<ul aria-labelledby="dropdownMenu2"
				...
				<li><a data-toggle="modal" data-target=".modalChangeProfile"><i class="ti-user mr-5"></i> ប្តូររូបភាពគណនី</a></li>
            <!-- <li><a data-toggle="modal" data-target=".modalChangeUserInformation"><i class="ti-settings mr-5"></i> ការកំណត់គណនី</a></li> -->
            <li><a href="/logout"><i class="ti-power-off mr-5"></i> ចាកចេញ</a></li>
			</ul></li>
		<li><a href="javascript:;" role="button"
			class="right-sidebar-toggle bubble header-icon"><i
				class="ti-layout-sidebar-right"></i></a></li>
	</ul>
</div>
