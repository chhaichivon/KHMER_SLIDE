  ...
  <body data-sidebar-color="sidebar-light" class="sidebar-light">
    ...
    <div class="main-container">
      ...
      <aside data-mcs-theme="minimal-dark" style="background-image: url(../../images/backgrounds/11.jpg)" class="main-sidebar mCustomScrollbar">
        <div class="user">
          <div id="esp-user-profile" data-percent="65" style="height: 130px; width: 130px; line-height: 100px; padding: 15px;" class="easy-pie-chart"><img src="../../images/users/04.jpg" alt="" class="avatar img-circle"><span class="status bg-success"></span></div>
